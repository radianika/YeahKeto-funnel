                  ...
                  {packages.map(pack => (
                    <div key={pack.id} className="pkg">
                      <a
                        ...
                        className={
                          pack.id === this.state.selected.id && 'picked'
                        }
                        onClick={() => {
                ...
                <div className="chk-rgt">
                  ...
                  <div className="moneyback-box">
                    ...
                    <p className="moneyback-txt">
                      Your purchase is insured by our 90 Day Money Back
                      Guarantee, which ensures that if you are completely
                      satisfied with the results, we will refund your money, no
                      questions asked.{' '}
                    </p>
                  </div>
                  <img
