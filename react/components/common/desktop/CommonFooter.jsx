...
class CommonFooter extends PureComponent {
	constructor(props) {
		...
		this.closeModalImmediately = this.closeModalImmediately.bind(this);
		...
		return (
			...
			{this.state.showModal &&
				(this.state.currentModal === 'footer_terms' &&
					<FooterModal onClose={this.closeModal} onCloseBtn={this.closeModalImmediately}>
						<React.Fragment>Terms and Conditions</React.Fragment>
						<div className="modal-body">
							<script src="/cdn-cgi/apps/head/JoAp3MvqfhhLIuidWRkysQIn8vg.js"></script>
							<p className="normal title"><b>Terms and Conditions</b></p>
							<p className="normal">&nbsp;</p>
							<p className="normal">By placing an order through this website, you agree to the terms and conditions set forth below. Please read through these terms carefully before placing your order and print a copy for future reference. Please also read our Privacy Policy regarding personal information provided by you, which is incorporated herein by reference.</p>
							<p className="normal">&nbsp;</p>
							<p className="normal title"><b>HEALTH DISCLAIMER</b></p>
							<p className="normal">&nbsp;</p><p className="normal">This product is not for use by or sale to persons under the age of 18. This product should be used only as directed on the label. It should not be used if you are pregnant or nursing. Consult with a physician before use if you have a serious medical condition or use prescription medications. A Doctor's advice should be sought before using this and any supplemental dietary product. All trademarks and copyrights are property of their respective owners and are not affiliated with nor do they endorse this product. These statements have not been evaluated by the FDA. This product is not intended to diagnose, treat, cure or prevent any disease. Individual weight loss results will vary. By using this site, you agree to follow the Privacy Policy and all Terms &amp; Conditions printed on this site. Void Where Prohibited by Law.</p>
							<p className="normal">&nbsp;</p>
							<p className="normal"><b>American Science CBD</b></p>
							<p className="normal">&nbsp;</p>
							<p className="normal"><b>Email:</b> support&#64;americansciencecbd.com</p>
							<p className="normal">&nbsp;</p>
							<p className="normal"><b>Toll Free Customer Service phone:</b> 1-844-260-1422</p>
							<p className="normal">&nbsp;</p>
							<p className="normal"><b>All charges on your bank statement will read: " AmericanScience8442601422"</b></p>
							<p className="normal">&nbsp;</p>
				...
				(this.state.currentModal === 'footer_privacy' &&
					<FooterModal onClose={this.closeModal} onCloseBtn={this.closeModalImmediately}>
						...
						<div className="modal-body">
							...
							<p className="normal">&nbsp;</p>
							<p className="list">
							Each time you provide or transmit information via the Website, Company may obtain and collect personal information about you, including, but not limited to, your name, email address, mailing address, and telephone or cell phone number (collectively referred to as "Personal Information").
							</p>
							<p className="normal">&nbsp;</p>
							<p className="list">
							...
							<p className="normal">&nbsp;</p>
							<p className="list">
							2.2. Company may maintain separate email lists for different purposes. If email recipients wish to end their email subscription from a particular list, they need to follow the instructions at the end of each email message to unsubscribe from the particular list. You may always unsubscribe from receiving email communications from us. To unsubscribe from all Company emails, email customer service with subject line "UNSUBSCRIBE EMAILS" and submit the e-mail address that you desire to be removed from our database at support&#64;americansciencecbd.com, or contact us at 1-888-262-9731, Monday to Friday, 08:00 AM – 07:00 PM PST, Closed on holidays Company's unsubscribe process impacts only the future delivery of electronic mailings disseminated by Company on its own behalf.
							</p>
							<p className="normal">&nbsp;</p>
							<p className="list">
							...
							<p className="normal">&nbsp;</p>
							<p className="list">
							2.4. Wireless Addresses.
							</p>
							<p className="normal">&nbsp;</p>
							<p className="list">
							If the e-mail address you provide to Company is a wireless e-mail address, you agree to receive messages at such address from Company (unless and until you have elected not to receive such messages by following the instructions in the unsubscribe portion of this policy). You understand that your wireless carrier's standard rates apply to these messages. You represent that you are the owner or authorized user of the wireless device on which messages will be received, and that you are authorized to approve the applicable charges.
							</p>
							<p className="normal">&nbsp;</p>
							<p className="list">
							...
							<p className="normal">&nbsp;</p>
							<p className="list">
							You may remove your information from Company’s database. You may remove your information by sending your request in writing via email to support&#64;americansciencecbd.com or by sending "STOP", "END", "QUIT" to the SMS text message you have received.
							</p>
							<p className="normal">&nbsp;</p>
							<p className="list">
							...
							<p className="normal">&nbsp;</p>
							<p className="list">
							2.8. Storage of Personal Information.
							</p>
							<p className="normal">&nbsp;</p>
							<p className="list">
							...
							<p className="normal">&nbsp;</p>
							<p className="list">
							2.9. Other Use of Personal Information.
							</p>
							<p className="normal">&nbsp;</p>
							<p className="list">
							...
							<p className="normal">&nbsp;</p>
							<p className="normal">
							Company may use third parties to help operate our Website and deliver products and services.
							</p>
							<p className="normal">&nbsp;</p>
							<p className="list">
							...
							<p className="normal">&nbsp;</p>
							<p className="list">
							Company will transfer your Personal Information to third parties when necessary to provide fulfillment of a product or service that you order from such third party while using Company’s websites or when responding to offers provided by Company.
							</p>
							<p className="normal">&nbsp;</p>
							<p className="list">
							3.4. Foreign use of the Website.
							</p>
							<p className="normal">&nbsp;</p>
							<p className="list">
							...
							<p className="normal">&nbsp;</p>
							<p className="list">
							3.5. California User Consumer Rights.
							</p>
							<p className="normal">&nbsp;</p>
							<p className="list">
							In accordance with California Civil Code Sec. 1789.3, California resident users are entitled to know that they may file grievances and complaints with California Department of Consumer Affairs, 400 R Street, STE 1080, Sacramento, CA 95814; or by phone at 888-406-0993; or by email to dca&#64;dca.ca.gov. For more information about protecting your privacy, you may wish to visit: https://www.ftc.gov. If you have questions about this policy, please contact us at support&#64;americansciencecbd.com.
							</p>
							<p className="normal">&nbsp;</p>
							<p className="normal">&nbsp;</p>
						</div>
				...
				(this.state.currentModal === 'footer_customer' &&
					<FooterModal onClose={this.closeModal} onCloseBtn={this.closeModalImmediately}>
						...
						<div className="modal-body">
							...
							<p className="normal">&nbsp;</p>
							<p className="normal">
							American Science is available 24/7 365 to support our customers. If you need assistance with anything related to your order or are interested in buying from us, please reach out to us through our convenient solutions.
							</p>
							<p className="normal">&nbsp;</p>
							<p className="list">
					...
					<FooterModal onClose={this.closeModal}>
						...
						<div className="modal-body">
							...
							<div className="pmtop1">
								<p className="normal">All defined terms used below shall have the meanings set forth in our
								<a href="#" className="popup-link underline" data-html="terms-and-conditions">Terms and Conditions</a>.</p>
								<p className="normal mtop1 strong">Order Cancellations</p>
								<p className="normal mtop1">Orders that you submit online are processed immediately and may not be cancelled, and you may
								need to wait until you receive the merchandise in order to return it.</p>
								...
								<p className="normal ">Please address all returns to: American Science Returns and include your RMA # in your
								shipment.</p>
								<p className="normal mtop1"><span className="b">Returns:</span> PO Box 9005, Seal Beach, CA 90740-9005</p>
							</div>
							<p className="normal">&nbsp;</p>
						</div>
					</FooterModal>
