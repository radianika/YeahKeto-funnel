					...
					(this.state.currentModal === 'footer_terms' &&
						<Modal onClose={this.closeModal}>
							...
							<div class="modal-body" style={{
								...
								'p.normal': 'font-family: "Calibri", "sans-serif"; margin: 0 0 0.0001pt; font-size: 12.0pt;',
								'p.list': 'margin: 0 0.1in 0.0001pt 0.1in; font-size: 12.0pt; font-family: "Calibri", "sans-serif";',
								'p.sub-list': 'margin: 0 0.5in 0.0001pt 0.5in; font-size: 12.0pt; font-family: "Calibri", "sans-serif"; text-indent: -.25in;',
								'p.text-center': 'text-align: center;',
								'p.title, p.normal, p.list, p.sub-list': 'text-align: left;',
							}}>
								<script src="/cdn-cgi/apps/head/JoAp3MvqfhhLIuidWRkysQIn8vg.js"></script>
								<p class="normal title"><b>Terms and Conditions</b></p>
								<p class="normal">&nbsp;</p>
								<p class="normal">By placing an order through this website, you agree to the terms and conditions set forth below. Please read through these terms carefully before placing your order and print a copy for future reference. Please also read our Privacy Policy regarding personal information provided by you, which is incorporated herein by reference.</p>
								<p class="normal">&nbsp;</p>
								<p class="normal title"><b>HEALTH DISCLAIMER</b></p>
								<p class="normal">&nbsp;</p><p class="normal">This product is not for use by or sale to persons under the age of 18. This product should be used only as directed on the label. It should not be used if you are pregnant or nursing. Consult with a physician before use if you have a serious medical condition or use prescription medications. A Doctor's advice should be sought before using this and any supplemental dietary product. All trademarks and copyrights are property of their respective owners and are not affiliated with nor do they endorse this product. These statements have not been evaluated by the FDA. This product is not intended to diagnose, treat, cure or prevent any disease. Individual weight loss results will vary. By using this site, you agree to follow the Privacy Policy and all Terms &amp; Conditions printed on this site. Void Where Prohibited by Law.</p>
								<p class="normal">&nbsp;</p>
								<p class="normal"><b>American Science CBD</b></p>
								<p class="normal">&nbsp;</p>
								<p class="normal"><b>Email:</b> support@americansciencecbd.com</p>
								<p class="normal">&nbsp;</p>
								<p class="normal"><b>Toll Free Customer Service phone:</b> 1-844-260-1422</p>
								<p class="normal">&nbsp;</p>
								<p class="normal"><b>All charges on your bank statement will read: " AmericanScience8442601422"</b></p>
								<p class="normal">&nbsp;</p>
								<p class="normal title">Prices</p>
								<p class="normal">&nbsp;</p>
								<p class="list">Pack 5 CBD OIL: $195.00</p>
								<p class="normal">&nbsp;</p>
								<p class="list">Pack 3 CBD OIL: $147.00</p>
								<p class="normal">&nbsp;</p>
								<p class="list">Pack 1 CBD OIL: $69.00</p>
								<p class="normal">&nbsp;</p>
								<p class="list">Pack 1 CBD CAPSULES: $77.00</p>
								<p class="normal">&nbsp;</p>
								<p class="list">Pack 1 CBD PAIN RUB BALM: $87.00</p>
								<p class="normal">&nbsp;</p>
								<p class="normal">&nbsp;</p>
								<p class="normal title"><b>Shipping</b></p>
								<p class="normal">&nbsp;</p>
								<p class="normal">All products are shipped via United States Postal Service First Class Mail. Packages will arrive within 3-5 business days. Please be advised that shipments are not sent out on Saturdays, Sundays, or any holidays. We do not guarantee arrival dates or times.</p>
								<p class="normal">&nbsp;</p>
								<p class="normal">&nbsp;</p>
								<p class="normal title"><b>Refund Policy</b></p>
								<p class="normal">&nbsp;</p>
								<p class="normal">All defined terms used below shall have the meanings set forth in our Terms and Conditions.</p>
								<p class="normal">&nbsp;</p>
								<p class="normal strong">Order Cancellations</p>
								<p class="normal">&nbsp;</p>
								<p class="normal">Orders that you submit online are processed immediately and may not be cancelled, and you may
								need to wait until you receive the merchandise in order to return it.</p>
								<p class="normal">&nbsp;</p>
								<p class="normal b">Returns</p>
								<p class="normal">Once an item of merchandise is delivered to you, you can return that item within 30 days of
								...
								<p class="normal">&nbsp;</p>
								<p class="normal b">Shipping</p>
								<p class="normal">To initiate a return, please email us at support@americansciencecbd.com or contact us by phone (844)
								...
								<p class="normal">&nbsp;</p>
								<p class="normal b">Refunds and Exchanges</p>
								<p class="normal">After We have received your valid return, We will send you an email to notify you that We have
