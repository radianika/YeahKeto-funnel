...
import 'styles/footer-modal.scss';
...
class FooterModal extends PureComponent {
	...
	render() {
		return (
			<div className="modal fade in" id="popupModal" role="dialog" style={{
				'display': 'block'
			}} onClick={this.props.onClose}>
				<div className="modal-dialog" role="document">
					<div className="modal-content">
						<div className="modal-header">
							<button type="button" className="close close-modal" data-dismiss="modal" aria-label="Close" onClick={this.props.onCloseBtn}>
