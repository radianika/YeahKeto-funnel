...
const TextField = props => {
  ...
  return (
    <div
      className={`${props.containerClass} pure-control-group frmElemts fv-has-feedback ${hasError &&
    ...
    >
      ...
      <i
        ...
        className={`fv-control-feedback ${hasError && 'fa fa-times'} ${valid && 'fa fa-check'}`}
      />
