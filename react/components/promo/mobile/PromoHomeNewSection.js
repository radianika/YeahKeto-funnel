      ...
      <div className="container">
        ...
        <div className="section-2">
          ...
          <p className="s2-parag-txt">
            Join The Keto Lifestyle &amp; Lose Up To 1 lb per day!
          </p>
          ...
          <ul className="slider">
            ...
            <li>
              ...
              />
              <p className="common-txt cmn-itlic">
                Supplementing Yeah Keto with a keto diet was the perfect recipe
                for shedding those extra pounds I gained while pregnant. I feel
        ...
        <div className="section-3">
          ...
          <p className="s2-parag-txt">
            Ketosis Helps Your Body Burn Fat For Energy!
          </p>
          <div className="clearall" />
        ...
        <div className="section-7">
          ...
          <p className="s2-parag-txt">
            Experience Real Transformation WIth <b>Yeah Keto</b>!
          </p>
          ...
          <ul className="slider">
            <li>
              ...
              <p className="slide-txt1">
                <span>- Erica J. </span> | Los Angeles &nbsp;&nbsp;<img src="/static/promo/mobile/images/images/s2-star.png" />
              </p>
            </li>
            <li>
              ...
              <p className="slide-txt1">
                <span>- Jane C.</span> | New York &nbsp;&nbsp;<img src="/static/promo/mobile/images/images/s2-star.png" />
              </p>
            </li>
            <li>
              ...
              <p className="slide-txt1">
                <span>- Cher N.</span> | South Carolina &nbsp;&nbsp;<img src="/static/promo/mobile/images/images/s2-star.png" />
              </p>
            </li>
          </ul>
        </div>
