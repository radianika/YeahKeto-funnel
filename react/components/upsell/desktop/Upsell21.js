                ...
                <div className="upsell-sec">
                  ...
                  <div className="up-box-bg">
                    <div className="up-lft">
                      <img
                        src="/static/promo/desktop/images/images/up-prd.png"
                        alt=""
                        className="up-prd"
                      />
                      <img
                        src="/static/promo/desktop/images/images/up-lft-img1.png"
                        alt=""
                    ...
                    <div className="up-rgt">
                      ...
                      <img
                        src="/static/promo/desktop/images/images/up1-logo.png"
                        className="up1-logo"
                        alt=""
                      />
                      ...
                      <ul className="up-list">
                        <li>
                          <img
                            src="/static/promo/desktop/images/images/up-tick.png"
                            alt=""
                            className="for-desk"
                          />
                          <p>
                      ...
                      <div className="up-prd-info">
                        <p className="up-prd-p1">
                          Add Your <span>Special Discounted</span> Bottle<br />Just
                          Pay a Special Price{' '}
                          <span>
                            <img
                        ...
                        <a href="#" onClick={this.skipUpsell}>
                          <p className="no-p">
                            {' '}
