...
const SatisfactionBox = props => (
  <React.Fragment>
    <div className="upsell-strip">
      <h4 className="strip-txt3">BENEFITS OF CANNABINOID (CBD) CAPSULES INCLUDE...</h4>
    </div>
    ...
    <div className="up-bottom-box box1">
      ...
      <p className="box-txt2">
        CBD Hemp Oil Capsules contains a high potency blend of 300mg - Full Spectrum Cannabinoids to
        offer maximum therapeutic benefits.
      </p>
    </div>
    <div className="up-bottom-box">
      ...
      <p className="box-txt2">
        The Hemp Oil Capsules help support overall cognitive health while also boosting focus,
        mental clarity, and memory recall.
      </p>
    </div>
    <div className="up-bottom-box">
      ...
      <p className="box-txt2">
        CBD Hemp Oil Capsules work at a cellular level to combat free radical damage and boost
        overall immunity.{' '}
      </p>
    </div>
