                ...
                <div className="upsell-sec">
                  ...
                  <div className="up-box-bg up2-box-bg">
                    <div className="up-lft up2-lft">
                      <img
                        src="/static/promo/desktop/images/images/up2-pro.png"
                        alt=""
                        className="up-prd"
                      />
                      <img
                        src="/static/promo/desktop/images/images/up2-lft-img1.png"
                        alt=""
                    ...
                    <div className="up-rgt">
                      ...
                      <img
                        src="/static/promo/desktop/images/images/up2-logo.png"
                        className="up1-logo"
                        alt=""
                      />
                      ...
                      <ul className="up-list">
                        <li>
                          <img
                            src="/static/promo/desktop/images/images/up2-tick.png"
                            alt=""
                            className="for-desk"
                          />
                          <p>
